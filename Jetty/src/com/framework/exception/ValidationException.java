...
public class ValidationException  extends Exception{
	...
	public ValidationException(String messageKey,String errorCode) {
		super(messageKey);
		this.errorCode = errorCode;
		this.messageKey = messageKey;
	}
	public ValidationException(String messageKey,Object[] paramArgs,String errorCode) {
		super(messageKey);
		this.errorCode = errorCode;
		this.messageKey = messageKey;
		this.paramArgs = paramArgs;
	}
	public ValidationException(String messageKey,Object[] paramArgs) {
		super(messageKey);
		this.messageKey = messageKey;
		this.paramArgs = paramArgs;
	}
